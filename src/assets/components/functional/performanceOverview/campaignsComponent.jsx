...
},
{
 ...
 renderCell: (params) => (
    ...
    const getCampaignsData = async () => {
        ...
        try {
            const url = `https://react-api-script.onrender.com/gcpl/campaign?start_date=${startDate}&end_date=${endDate}&platform=${operator}`;
    ...
    const confirmStatusChange = async (campaignId, campaignType) => {
        try {
            ...
            const response = await fetch(`https://react-api-script.onrender.com/gcpl/update_campaign_status?${params.toString()}`, {
                method: "PUT",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${token}`,
