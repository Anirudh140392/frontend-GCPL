...
const SmartControlDatatable = () => {
  ...
  const getRulesData = async () => {
    ...
    try {
      const response = await fetch(`https://react-api-script.onrender.com/gcpl/displayrules?platform=${operator}`, {
        method: "GET",
        headers: {
  ...
  const toggleRuleStatus = async (ruleId, currentStatus) => {
    ...
    try {
      const response = await fetch(`https://react-api-script.onrender.com/gcpl/play-pause-rule?rule_id=${ruleId}&platform=${operator}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const deleteRule = async (ruleId, status) => {
    ...
    try {
      const response = await fetch(`https://react-api-script.onrender.com/gcpl/delete-rule?rule_id=${ruleId}&platform=${operator}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
