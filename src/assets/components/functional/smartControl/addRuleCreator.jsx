...
const normalizeFilters = (filters) => {
    ...
    if (platform === "Flipkart") {
        return `https://react-api-script.onrender.com/gcpl/update-rule?rule_id=${ruleData.rule_id}&platform=${platform}`;
    } else if (platform === "BigBasket") {
        return `http://react-api-script.onrender.com/gcpl/update-rule?platform=${platform}&rule_id=${ruleData.rule_id}`;
    }
    return "";
};
